...
> Custom Count-Down is a website built with HTML, CSS, and JavaScript. We utilize linters to prevent code errors and ensure clean code. Additionally, we employ local storage to retain user data locally. Please take a look at our live demo.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Custom-Count-Down/src/)
